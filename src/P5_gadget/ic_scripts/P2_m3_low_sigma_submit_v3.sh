#!/usr/bin/env bash
#SBATCH --job-name=P2_m3_low_sigma
...
echo "=== Starting P2_m3_low_sigma at $(date) ==="
echo "Job ID: $SLURM_JOB_ID on $(hostname)"
echo "Mem avail: $(free -h | head -2)"
echo "Working dir: $(pwd)"
echo "Executable: ~/dsidm_project/source/Gadget4_P2_m3_low_sigma"
ls -la ~/dsidm_project/source/Gadget4_P2_m3_low_sigma
echo "Params:"
head -5 params.txt
echo "---"
echo "IC file:"
...
~/dsidm_project/source/Gadget4_P2_m3_low_sigma params.txt 2>&1 | tee run.log
rc=$?
echo "=== Finished P2_m3_low_sigma at $(date) with exit code $rc ==="
